...
public interface InventoryIndexMapper {
    ...
    @Select("""
            select box_id, box_index, item_number, box_name, box_number, sealed, quantity, description from inventory_index ii \
    ...
    @Insert("""
            INSERT INTO inventory_index(box_id, box_index, item_number, box_name, box_number, sealed, quantity, description) \
